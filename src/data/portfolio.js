...
export const projects = [
  ...
  {
    title: "Sistem Manajemen Klinik Desktop",
    status: "Selesai / Pengembangan Berkelanjutan",
    github: "https://github.com/NielSianipar/klinik-desktop.git",
    description:
      "Aplikasi desktop JavaFX untuk mengelola operasional klinik, mulai dari pasien, dokter, antrian, rekam medis, apotek, hingga laporan kunjungan.",
    features: [
      "Login Berbasis Role",
      "Autentikasi BCrypt",
      "Dashboard Klinik",
    ...
    tech: ["Java", "JavaFX", "MySQL", "Maven", "JDBC", "BCrypt"],
  },
  {
    title: "Smart Inventory System",
    status: "Selesai / Pengembangan Berkelanjutan",
    github: "https://github.com/Kelvin07-neww/Smart-Inventory.git",
    description:
      "Aplikasi desktop JavaFX untuk manajemen inventori dan penjualan CV. SERBA ADA dengan dashboard, transaksi, dan laporan PDF.",
    features: [
      "Login Pengguna",
      "Migrasi Password ke BCrypt",
      "Dashboard Inventori dan Penjualan",
      "CRUD Kategori",
      "CRUD Supplier",
      "CRUD Barang",
      "Transaksi Penjualan",
      ...
      "Pengaturan Profil dan Tema",
    ],
    tech: ["Java", "JavaFX", "MySQL", "Maven", "BCrypt", "PDFBox"],
  },
];
